...
_G.packer_plugins = {
  VimCompletesMe = {
    loaded = true,
    path = "/home/gamerssassin/.local/share/nvim/site/pack/packer/start/VimCompletesMe",
  ...
  ["lsp_lines.nvim"] = {
    ...
    loaded = true,
    path = "/home/gamerssassin/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["nvim-lspconfig"] = {
    ...
    loaded = true,
    path = "/home/gamerssassin/.local/share/nvim/site/pack/packer/start/nvim-lspconfig",
